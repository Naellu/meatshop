						...
						<div id="collapse${inquiry.inquiryId}"
							...
							<div class="accordion-body" >
								...
								<div class="mb-3"
									...
									<button id="answerUpdateBtn${productAnswer.inquiryId}"
										class="answerUpdateButton btn btn-secondary"
										onclick="location.herf='proudctanswer/modify?inquiryId=${productAnswer.inquiryId}'">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" id="removeInquiryBtn" class="btn btn-outline-danger"
					form="inquiryRemoveForm"
...
<div class="modal fade" id="deleteAnswerConfirmModal" tabindex="-1"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button id="deleteAnswerModalButton" data-bs-dismiss="modal"
