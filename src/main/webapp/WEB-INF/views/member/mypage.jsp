...
-->
	...
	<div>
		<p data-v-c2bdf878="" class="mypage-container__title">마이페이지</p>
		<section data-v-c2bdf878="" class="mypage__userinfo-box">
			...
			<div data-v-c2bdf878="" class="mypage-userinfo__data">
				<div data-v-c2bdf878="" class="mypage-userinfo__data-top">
					<p data-v-c2bdf878="" class="mypage-userinfo__name">환영합니다, ${member.id } 님</p>
					<button data-v-c2bdf878="" class="mypage-userinfo__signout">로그아웃</button>
					<button data-v-c2bdf878="" class="mypage-userinfo__question"><a class="btn btn-secondary" href="/question/list">내 문의 내역</a></button>
				</div>
		...
		<div data-v-c2bdf878="" class="mypage-tab__centered">
			...
			<div>
				<button type="button" class="btn btn-primary btn-lg">
					<a class="nav-link" href="/product/list">쇼핑하러가기</a> <i></i>
				</button>
			</div>
