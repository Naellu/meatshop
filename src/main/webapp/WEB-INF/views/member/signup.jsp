		...
		<div class="row justify-content-center">
			<div class="col-12 col-md-8 col-lg-6">
				...
				<form method="post">
					...
					<div class="mb-3">
						...
						<div class="d-none form-text text-danger"
							id="notAvailableIdMessage">
					...
					<div class="mb-3">
						<label for="inputName" class="form-label">이름</label> <input
							id="inputName" type="text" class="form-control" name="name" />
					</div>
					<div class="mb-3">
						<label for="inputbirthday" class="form-label">생일</label> <input
							id="inputbirthday" type="date" class="form-control"
							name="birthday" />
					</div>
					...
					<div class="mb-3">
						<label for="inputAddress" class="form-label">주소</label> <input
							id="inputAddress" type="text" class="form-control" name="address" />
					</div>


					<div class="mb-3">
						<label for="inputaddress" class="form-label">전화번호</label> <input
							id="inputPhoneNumber" type="text" class="form-control"
							name="phoneNumber" />
					</div>
					...
					<div class="mb-3">
						...
						<input id="inputPasswordCheck" type="password"
							class="form-control" />

						<div id="passwordSuccessText"
							class="d-none form-text text-primary">
			...
			<div class="mb-3">
				...
				<div class="input-group">
					...
					<div class="d-none form-text text-primary"
						id="availableEmailMessage">
						<i class="fa-solid fa-check"></i> 사용 가능한 이메일입니다.
					</div>
					<div class="d-none form-text text-danger"
						id="notAvailableEmailMessage">
				...
				<div class="form-group email-form">
					...
					<div class="mail-check-box">
						<input class="form-control mail-check-input"
							placeholder="인증번호 2자리를 입력해주세요!" maxlength="6" id="mailconfirm">
					</div>
					<span id="emailconfirmTxt">hihi</span>
				</div>


				<div class="mb-3">
					<input id="signupSubmit" type="submit" class="btn btn-primary"
						value="가입" disabled />
				</div>
				</form>
			</div>
