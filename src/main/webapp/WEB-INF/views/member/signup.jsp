			...
			<div class="col-12 col-md-8 col-lg-6">
				...
				<form method="post">
					...
					<div class="mb-3">
						...
						<input id="inputName" type="text" class="form-control" name="member_name" />
					</div>
					<div class="mb-3">
						<label for="inputbirthday" class="form-label">생일</label>
						<input id="inputbirthday" type="date" class="form-control" name="member_birthday" />
					</div>
					<div class="mb-3">
						<label for="inputaddress" class="form-label">주소</label>
						<input id="inputaddress" type="text" class="form-control" name="member_address" />
					</div>
					
					<div class="mb-3">
						<label for="inputaddress" class="form-label">전화번호</label>
						<input id="inputaddress" type="text" class="form-control" name="member_phone_number" />
					</div>
					
					<div class="mb-3">
						<label for="inputPassword" class="form-label">패스워드</label>
						<input id="inputPassword" type="password" class="form-control" name="member_password" />
					</div>
