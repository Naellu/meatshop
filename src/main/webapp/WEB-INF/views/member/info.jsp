		...
		<div class="container-lg">
			<div class="row justify-content-center">
				<div class="col-12 col-md-8 col-lg-6">
					...
					<div class="mb-3">
						<label class="form-label" for="">패스워드</label> <input class="form-control" type="password" value="${member.password }" readonly />
					</div>
					...
					<div class="mb-3">
						<label class="form-label" for="inputAdress"> 주소 </label> <input id="inputAdress" class="form-control" type="text" name="address" value="${member.address }" readonly />
					</div>
					<div class="mb-3">
