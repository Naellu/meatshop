			...
			<div class="col-12 col-md-8 col-lg-6">
				...
				<form method="post">
					...
					<div class="mb-3">
						...
						<input class="form-control" id="titleInput" type="text" name="title" value="${faq.title }" />
					</div>

					<div class="mb-3">
						<label for="contentTextarea" class="form-label">본문</label>
						<textarea class="form-control" id="contentTextarea" rows="10" name="content">${faq.content }</textarea>
					</div>
